...
max_step = 120000  # 30000 for ukbb
...
step_size = 12000  # 7000 for DRIVE
...
dilation_list =  [0] # default: [0,5,9], [0,7,11] for HRF
lambda_centerness = 1
lambda_dilation_list = [1] # default :[1,1,1]
...
model_path_pretrained_G = './log/2023_03_01_11_17_15'
model_step_pretrained_G = 25000
...
# use network
use_network = 'swin_t' # swin_t,convnext_tiny
...
dataset_path = {'DRIVE': './data/AV_DRIVE/training/',
                ...
                'ukbb_centerness': './data/centerness_maps/ukbb' + dilation_list_str + '/training/',
                'ukbb_shuffle': './data/shuffled_dataset/ukbb/training/',
